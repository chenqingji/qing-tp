...
class CategoryController extends WrapController {
    ...
    public function index() {
        $menuCrumbs = array(
            ...
            "second" => array("menuName" => "普通品类列表", "url" => "/Index/Category/index"),
        );
...
//        echo ":选择编号;001:001;002:002;003:003;004:004";exit;
    ...
    public function add() {
        $menuCrumbs = array(
            "first" => $this->_menuCrumbsFirst,
            "second" => array("menuName" => "新增普通品类", "url" => "/Index/Category/add"),
        );
    ...
    public function edit($id = 0) {
        ...
        $menuCrumbs = array(
            "first" => $this->_menuCrumbsFirst,
            "second" => array("menuName" => "编辑普通品类", "url" => "/Index/Category/edit"),
        );
