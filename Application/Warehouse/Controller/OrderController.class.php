...
class OrderController extends WrapController {
    ...
    public function index() {
        $menuCrumbs = array(
            ...
            "second" => array("menuName" => "订单列表", "url" => "/Warehouse/Order/index"),
        );
...
//        $field = "*";
    ...
    public function products() {
        $menuCrumbs = array(
            "first" => $this->_menuCrumbsFirst,
            "second" => array("menuName" => "商品列表", "url" => "/Warehouse/Order/products"),
        );
        $this->assign("menuCrumbs", $menuCrumbs);
...
//        $field = "*";
    ...
    public function addNormal() {
        $menuCrumbs = array(
            "first" => $this->_menuCrumbsFirst,
            "second" => array("menuName" => "添加普通订单", "url" => "/Warehouse/Order/addNormal"),
        );
