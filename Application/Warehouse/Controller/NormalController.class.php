...
//        $data['op_userid'] =$this->getUseridByBarCode(I("post.operator",''));
        ...
        \Warehouse\Common\Marktest::writeTestData($categoryInfo, false);
        ...
        \Warehouse\Common\Marktest::writeTestData($data);
        //记录更新员工、品类编号、入库数量、时间
     ...
     * 入库前对品类相关信息验证
     * @param array $data
     * @param \Warehouse\Model\CategoryModel $categoryModel
     * @return array 品类信息
     */
